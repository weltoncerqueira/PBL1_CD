...
module equacao_completa (
    ...
    multiplicador_sinalizado_8x8 multp1 (
        .a(x),
        .b(x),
        .saida_final(x_quadrado)   // VERIFIQUE O NOME DA PORTA NO SEU MÓDULO!
    );
    ...
    multiplicador_sinalizado_8x8 multp2 (
        .a(x),
        .b(8'd5),
        .saida_final(cinco_x)      // VERIFIQUE O NOME DA PORTA NO SEU MÓDULO!
    );
    ...
    // --- Saídas ---
    assign y = soma2;                     // Resultado da função
