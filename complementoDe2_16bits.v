...
module complementoDe2_16bits (
    ...
    not n8 (notA[8],  A[8]);
    not n9 (notA[9],  A[9]);
    not n10(notA[10], A[10]);
    not n11(notA[11], A[11]);
    not n12(notA[12], A[12]);
    not n13(notA[13], A[13]);
    not n14(notA[14], A[14]);
    ...
    mux_2x1_16bits mux_resultado (
        ...
        .notIn(complemento),  // entrada 1: complemento (negativo)
